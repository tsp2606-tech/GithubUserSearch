  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-200 text-gray-900 dark:text-white flex flex-col items-center w-full">
      ...
      <main className="flex-1 w-full max-w-3xl px-4 py-8 flex flex-col gap-6">
        ...
        <div className="w-full bg-white dark:bg-slate-800 rounded-lg py-12 px-8 shadow-sm border border-gray-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
          <svg
          ...
          <h2 className="text-base font-bold text-gray-900 dark:text-white mb-2">Welcome to GitHub User Search</h2>
