  ...
  return (
    <div className="w-full bg-white dark:bg-slate-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-slate-700">
      <form className="flex flex-row gap-3">
        ...
        />
        <button type="submit" className="bg-green-500 hover:bg-green-600 text-white rounded-md px-6 py-2.5 flex flex-row items-center justify-center gap-2 font-medium text-sm transition-colors">
